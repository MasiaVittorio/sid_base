...
class GenericAnimatedBuilder extends ImplicitlyAnimatedWidget {
  ...
  @override
  AnimatedWidgetBaseState<GenericAnimatedBuilder> createState() => _GenericAnimatedBuilderState();
}

class _GenericAnimatedBuilderState extends AnimatedWidgetBaseState<GenericAnimatedBuilder> {
...
class AnimatedColorBuilder extends ImplicitlyAnimatedWidget {
  ...
  final bool animate;
  final Widget? child;
  final Widget Function(BuildContext context, Color? value, Widget? child) builder;

  @override
  AnimatedWidgetBaseState<AnimatedColorBuilder> createState() => _AnimatedColorBuilderState();
}

class _AnimatedColorBuilderState extends AnimatedWidgetBaseState<AnimatedColorBuilder> {
  ColorTween? _color;
