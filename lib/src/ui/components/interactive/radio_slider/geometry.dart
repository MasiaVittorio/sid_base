...
extension on _RadioSliderState {
  ...
  double height(RadioSliderThemeData? radioTheme) =>
      widget.height ?? radioTheme?.height ?? RadioSlider._kHeight;
  EdgeInsets margin(RadioSliderThemeData? radioTheme) =>
      widget.margin ?? radioTheme?.margin ?? RadioSlider._kMargin;
}
