...
class _FullSliderState extends State<FullSlider>
  ...
  Widget get _separator =>
      SizedBox(width: widget.mainAxisMargin, height: widget.mainAxisMargin);
  ...
  Widget build(BuildContext context) {
    ...
    final Color background = Color.alphaBlend(
      themeData.scaffoldBackgroundColor.withValues(alpha: 0.7),
      themeData
    ...
    final Color accentColor = Color.alphaBlend(
      widget.accentColor ??
          themeData.colorScheme.secondary.withValues(
            alpha: disabled ? 0.17 : 0.2,
          ),
      background,
    );
    final Color onBackgroundColor = themeData.colorScheme.onSurface.withValues(
      alpha: disabled ? 0.6 : 1.0,
    );
    final Color onAccentColor = accentColor.contrast.withValues(
      alpha: disabled ? 0.6 : 1.0,
    );
              ...
              child: GestureDetector(
                ...
                onVerticalDragCancel:
                    disabled || horizontal || widget.divisions != null
                        ...
                        : dragEnd,
                onTapUp:
                    disabled || widget.divisions == null
                        ? null
                        : (d) => tap(d, constraints),
                child: Stack(
                  children: <Widget>[
    ...
    if (widget.defaultValue == null) {
      return Padding(padding: margin, child: slider);
    }
